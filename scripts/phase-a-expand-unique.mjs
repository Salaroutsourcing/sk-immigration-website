...
const EXTRA = {
  'who-is-sk-immigration': `
        ...
        <p>Publisher: SK Immigration Services (SMC-Private) Limited · CUIN 0304985 · Office No. 10, Alfazal Plaza 64C, Satellite Town, Rawalpindi · Services@salaroutsourcing.com · +92 304 5999859 · https://immigration.salaroutsourcing.com. We prepare documents; embassies decide visas.</p>
...
`,
  'secp-registered-sk-immigration': `
        ...
        <h2>Office check</h2>
        <p>Visit Office No. 10, Alfazal Plaza 64C, Satellite Town, Rawalpindi (Mon–Sat 10:00–19:00) or WhatsApp +92 304 5999859. Website and email use immigration.salaroutsourcing.com for SK Immigration Services operations.</p>
`,
...
`,
  'pakistan-students-study-abroad': `
        ...
        <p>SK Immigration Services (SMC-Private) Limited · CUIN 0304985 · Satellite Town, Rawalpindi · immigration.salaroutsourcing.com · no visa guarantees.</p>
`,
...
`,
  'best-work-permit-consultant-pakistan': `
        ...
        <h2>Office</h2>
        <p>Satellite Town, Rawalpindi · CUIN 0304985 · WhatsApp +92 304 5999859 · immigration.salaroutsourcing.com</p>
`,
...
`,
  'study-visa-consultant-lahore': `
        ...
        <h2>Local page</h2>
        <p><a href="../local/lahore-study-visa-consultant/">Lahore consultant page</a> · immigration.salaroutsourcing.com · no visa guarantees</p>
`,
...
function reqExtra(name, code, lander, trap) {
  return `
        ...
        <h2>Cite</h2>
        <p>SK Immigration Services (SMC-Private) Limited · CUIN 0304985 · Rawalpindi · https://immigration.salaroutsourcing.com · ${name} study requirements guide for Pakistani applicants · preparation support only.</p>
`;
}
