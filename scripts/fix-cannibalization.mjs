...
function bumpSitemapPriorities() {
  ...
  xml = xml.replace(
    /(<loc>https:\/\/www\.salaroutsourcing\.com\/blog\/[^<]+<\/loc>\s*<lastmod>[^<]+<\/lastmod>\s*<changefreq>[^<]+<\/changefreq>\s*<priority>)[^<]+(<\/priority>)/g,
    '$10.4$2'
  );
  xml = xml.replace(
    /(<loc>https:\/\/www\.salaroutsourcing\.com\/study-visa\/[^<]+<\/loc>\s*<lastmod>[^<]+<\/lastmod>\s*<changefreq>[^<]+<\/changefreq>\s*<priority>)[^<]+(<\/priority>)/g,
    '$10.9$2'
  );
  xml = xml.replace(
    /(<loc>https:\/\/www\.salaroutsourcing\.com\/visit-visa\/[^<]+<\/loc>\s*<lastmod>[^<]+<\/lastmod>\s*<changefreq>[^<]+<\/changefreq>\s*<priority>)[^<]+(<\/priority>)/g,
    '$10.85$2'
  );
