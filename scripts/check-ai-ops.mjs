...
ok('robots lists sitemap', robots.includes('Sitemap: https://www.salaroutsourcing.com/sitemap.xml'));
...
ok('llms keeps domain', llms.includes('salaroutsourcing.com'));
...
ok('sitemap no duplicate home', (sm.match(/salaroutsourcing\.com\/<\/loc>/g) || []).length === 1);
...
if (live) {
  const urls = [
    'https://www.salaroutsourcing.com/robots.txt',
    'https://www.salaroutsourcing.com/llms.txt',
    'https://www.salaroutsourcing.com/trust.html',
    'https://www.salaroutsourcing.com/sitemap.xml',
  ];
  for (const u of urls) {
    try {
