...
export const SITE = {
  ...
  brandAliases: [
    ...
    'SK Immigration Dubai',
    'SK Immigration UAE',
    'SK Immigration Saudi Arabia',
    'SK Immigration Nepal',
    'SK Immigration Bangladesh',
    'SK Immigration Kathmandu',
    'SK Immigration Dhaka',
  ],
  tagline: 'Digital Immigration & Business Services',
  seoTitle: 'Digital Immigration Services | SK Immigration — PK, UAE, KSA, Nepal, BD',
  seoDescription:
    'Digital immigration desk with offices in Pakistan, Saudi Arabia, Dubai, Nepal and Bangladesh. Study visas, Ausbildung, visit files and attestation. Written fees. Embassies decide — no visa guarantees.',
